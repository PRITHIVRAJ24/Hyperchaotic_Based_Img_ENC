...
import os
import pickle
from src.encrypt import generate_chaotic_sequence, mse, psnr
...
def decrypt_image(enc_path):
    save_path="application/src/output/decrypted.png"
    original_img_path="application/src/Sample/Lenna.png"
...
# decrypt_image("encrypted.png", "decrypted.png", "application/src/Sample/Lenna.png")
